      ...
      <section className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-10 shadow-lg">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="rounded-lg p-6 border border-white/10 bg-white/3">
              <h2 className="text-lg font-semibold text-adv-navy">Office</h2>
              <p className="mt-2 text-sm text-gray-300">RL Associates, Near (landmark), City, Rajasthan, India</p>
              <p className="mt-2 text-sm text-gray-300">Phone: <a href="tel:+91-XXXXXXXXXX" className="text-adv-navy">+91-XXXXXXXXXX</a></p>
            ...
            <div className="rounded-lg p-6 border border-white/10 bg-white/3">
              ...
              <div className="mt-4 flex gap-3">
                <a href="mailto:info@rlassociates.example" className="inline-block bg-adv-gold text-white px-4 py-2 rounded-md">Email Us</a>
                <a href="tel:+91-XXXXXXXXXX" className="inline-block border border-adv-navy px-4 py-2 rounded-md text-adv-navy">Call Office</a>
              </div>
            </div>
          </div>

          <form className="space-y-4 bg-gradient-to-br from-white/3 to-white/5 p-6 rounded-lg border border-white/10">
            <div>
            ...
            <div className="flex items-center justify-between">
              <button type="submit" className="inline-block bg-adv-navy text-white px-5 py-2 rounded-md font-medium">Send Message</button>
