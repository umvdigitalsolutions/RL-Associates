    ...
    <main className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-16">
      <section className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-10">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <article className="rounded-lg p-4 sm:p-6 border border-white/10 bg-white/3">
            <h3 className="text-lg sm:text-xl font-semibold text-adv-navy">Criminal Defense</h3>
          ...
          <article className="rounded-lg p-4 sm:p-6 border border-white/10 bg-white/3">
            <h3 className="text-lg sm:text-xl font-semibold text-adv-navy">Corporate & Commercial</h3>
          ...
          <article className="rounded-lg p-4 sm:p-6 border border-white/10 bg-white/3">
            <h3 className="text-lg sm:text-xl font-semibold text-adv-navy">Civil Litigation</h3>
          ...
          <article className="rounded-lg p-4 sm:p-6 border border-white/10 bg-white/3">
            <h3 className="text-lg sm:text-xl font-semibold text-adv-navy">Regulatory & Compliance</h3>
          ...
          <article className="rounded-lg p-4 sm:p-6 border border-white/10 bg-white/3">
            <h3 className="text-lg sm:text-xl font-semibold text-adv-navy">Revenue Matters</h3>
          ...
          <article className="rounded-lg p-4 sm:p-6 border border-white/10 bg-white/3">
            <h3 className="text-lg sm:text-xl font-semibold text-adv-navy">Real Estate Law</h3>
            <p className="mt-2 text-sm text-gray-300">Conveyancing, title searches and land dispute resolution.</p>
            <Link href="/services/real-estate-law" className="mt-4 inline-block text-adv-gold font-medium">Learn more →</Link>
          </article>

          <article className="rounded-lg p-4 sm:p-6 border border-white/10 bg-white/3">
            <h3 className="text-lg sm:text-xl font-semibold text-adv-navy">Intellectual Property Rights (IPR)</h3>
            <p className="mt-2 text-sm text-gray-300">Assistance with intellectual property rights, including trademarks, copyrights, patents, and designs.</p>
            <Link href="/services/ipr" className="mt-4 inline-block text-adv-gold font-medium">Learn more →</Link>
          </article>

          {/* Land Registry replaced by Real Estate Law above */}
